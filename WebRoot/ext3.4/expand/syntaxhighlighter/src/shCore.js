...
var sh = {
	...
	config : {
		...
		strings : {
			...
			aboutDialog : '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title>代码高亮显示</title></head><body style="font-family:Geneva,Arial,Helvetica,sans-serif;background-color:#fff;color:#000;font-size:1em;text-align:center;"><div style="text-align:center;margin-top:3em;"><div style="font-size:xx-large;">代码高亮显示</div><div style="font-size:.75em;margin-bottom:4em;"><div>目前支持大多数的代码高亮显示功能</div><div></div></div></div></body></html>'
		},
