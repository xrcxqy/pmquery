...
<html>
  <head>
	...
	<script type="text/javascript" src="web/query/common/dnd_grid_to_grid.js"></script>
	<script type="text/javascript" src="web/query/common/searchOP.js"></script>
	<script type="text/javascript" src="web/query/pm/searchCmp.js"></script>
	<script type="text/javascript" src="web/query/pm/search.js"></script>
  </head>
  <body>
  	<div id="search"></div>
  </body>
